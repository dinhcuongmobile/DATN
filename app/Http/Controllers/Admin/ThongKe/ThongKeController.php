...
class ThongKeController extends Controller
{
    ...
    public function load30Ngay()
    {
        ...
        $donHang = DonHang::selectRaw('DATE(ngay_tao) as ngay_tao, SUM(tong_thanh_toan) as tong_thanh_toan, COUNT(*) as tong_don_hang')
            ->whereBetween('ngay_tao', [$sub30Ngay, $hienTai])->where('thanh_toan', 0)->groupBy('ngay_tao')->orderBy('ngay_tao', 'ASC')->get();
    ...
    public function thongKeDoanhSo(Request $request)
    {
        ...
        $donHang = DonHang::selectRaw('DATE(ngay_tao) as ngay_tao, SUM(tong_thanh_toan) as tong_thanh_toan, COUNT(*) as tong_don_hang')
            ->whereBetween('ngay_tao', [$fromDate, $toDate])->where('thanh_toan', 0)->groupBy('ngay_tao')->orderBy('ngay_tao', 'ASC')->get();
    ...
    public function thongKeDoanhSoBy(Request $request)
    {
        ...
        if ($data['dashboardValue'] == '7ngay') {
            $donHang = DonHang::selectRaw('DATE(ngay_tao) as ngay_tao, SUM(tong_thanh_toan) as tong_thanh_toan, COUNT(*) as tong_don_hang')
                ->whereBetween('ngay_tao', [$sub7Ngay, $hienTai])->where('thanh_toan', 0)->groupBy('ngay_tao')->orderBy('ngay_tao', 'ASC')->get();
        } elseif ($data['dashboardValue'] == 'thangTruoc') {
            $donHang = DonHang::selectRaw('DATE(ngay_tao) as ngay_tao, SUM(tong_thanh_toan) as tong_thanh_toan, COUNT(*) as tong_don_hang')
                ->whereBetween('ngay_tao', [$dauThangTruoc, $cuoiThangTruoc])->where('thanh_toan', 0)->groupBy('ngay_tao')->orderBy('ngay_tao', 'ASC')->get();
        } elseif ($data['dashboardValue'] == 'thangNay') {
            $donHang = DonHang::selectRaw('DATE(ngay_tao) as ngay_tao, SUM(tong_thanh_toan) as tong_thanh_toan, COUNT(*) as tong_don_hang')
                ->whereBetween('ngay_tao', [$dauThangNay, $hienTai])->where('thanh_toan', 0)->groupBy('ngay_tao')->orderBy('ngay_tao', 'ASC')->get();
        } else {
            $donHang = DonHang::selectRaw('DATE(ngay_tao) as ngay_tao, SUM(tong_thanh_toan) as tong_thanh_toan, COUNT(*) as tong_don_hang')
                ->whereBetween('ngay_tao', [$sub365Ngay, $hienTai])->where('thanh_toan', 0)->groupBy('ngay_tao')->orderBy('ngay_tao', 'ASC')->get();
        }
