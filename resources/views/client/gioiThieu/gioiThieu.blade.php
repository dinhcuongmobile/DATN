        ...
        <div class="row align-items-center gy-4">
            ...
            <div class="col-lg-6 order-2 order-lg-2">
                <div class="about-content">
                    ...
                    <p>With increased awareness about environmental issues, sustainable fashion has gained traction.
            ...
            <div class="col-lg-6 order-4 order-lg-3">
                <div class="about-content about-content-1">
                    ...
                    <p>Start with foundational pieces like well-fitted jeans, classic white shirts, and versatile
        ...
        <div class="row gy-4 align-items-end">
            ...
            <div class="col-md-4">
                <div class="fashion-box-1">
                    ...
                    <a href="product.html">Let's Check this out <i class="fa-solid fa-arrow-right-long"></i></a><img
            ...
            <div class="col-md-4">
                <div class="fashion-box-1 fashion-item"> <img class="img-fluid"
                        src="../assets/images/about/fashion-2.jpg" alt=""><a href="product.html">Let's Check this
