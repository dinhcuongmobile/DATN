...
<div class="align-items-center mb-4">
    <h1 class="h3 mb-0 text-gray-800">Thêm mới khuyến mại cho sản phẩm</h1>
    <div class="mt-3">
        @if (session('success'))
...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{route('san-pham.them-ma-khuyen-mai')}}" method="post" class="form">
            @csrf
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="{{route('san-pham.danh-sach-ma-khuyen-mai')}}"><button type="button" class="btn btn-secondary">Quay lại</button></a>
            </div>
        </form>
    </div>
</div>
