...
// function suaDiaChi(){
//     let btnSua = document.querySelectorAll("#address .suaDiaChi");
//     if(btnSua){
//         btnSua.forEach((el) => {
//             el.addEventListener('click',function(){
//                 let diaChiId = el.getAttribute('data-id');
...
//                             var hoVaTenErr = document.querySelector('#edit-box .hoVaTen p');
//                             hoVaTen.value = response.dia_chi.ho_va_ten_nhan;
//                             hoVaTenErr.textContent="";

//                             const soDienThoai = document.querySelector('#edit-box .soDienThoai input');
//                             var soDienThoaiErr = document.querySelector('#edit-box .soDienThoai p');
//                             soDienThoai.value = response.dia_chi.so_dien_thoai_nhan;
//                             soDienThoaiErr.textContent="";

//                             const tinhThanhPho = document.querySelector('#edit-box .tinhThanhPho select');
//                             var tinhThanhPhoErr = document.querySelector('#edit-box .tinhThanhPho p');
...
//                             var quanHuyenErr = document.querySelector('#edit-box .quanHuyen p');
...
//                             var phuongXaErr = document.querySelector('#edit-box .phuongXa p');
...
//                             const diaChiChiTiet = document.querySelector('#edit-box .diaChiChiTiet textarea');
//                             diaChiChiTiet.value = response.dia_chi.dia_chi_chi_tiet;

//                             let btnSubmit = document.querySelector('#edit-box .btn-submit');
//                             btnSubmit.addEventListener('click',function(){
//                                 var check = true;
//                                 if(hoVaTen.value==""){
//                                     check=false;
//                                     hoVaTenErr.textContent="Vui lòng không bỏ trống !";
//                                 }else hoVaTenErr.textContent="";

//                                 if(soDienThoai.value=="" || !(/^(0[3|5|7|8|9])+([0-9]{8})$/.test(soDienThoai.value))){
//                                     check=false;
//                                     soDienThoaiErr.textContent="Số điện thoại không hợp lệ !";
//                                 }else soDienThoaiErr.textContent="";

//                                 if (tinhThanhPho.value=="") {
//                                     check=false;
//                                     tinhThanhPhoErr.textContent="Vui lòng chọn Tỉnh Thành Phố !";
//                                 }else tinhThanhPhoErr.textContent="";

//                                 if (tinhThanhPho.value!=="" && quanHuyen.value=="") {
//                                     check=false;
//                                     quanHuyenErr.textContent="Vui lòng chọn Quận/Huyện !";
//                                 }else quanHuyenErr.textContent="";

//                                 if (tinhThanhPho.value!=="" && quanHuyen.value!=="" && phuongXa.value=="") {
//                                     check=false;
//                                     phuongXaErr.textContent="Vui lòng chọn Phường/Xã !";
//                                 }else phuongXaErr.textContent="";
...
//                                             dia_chi_id: diaChiId,
//                                             ho_va_ten_nhan: hoVaTen.value,
//                                             so_dien_thoai_nhan: soDienThoai.value,
//                                             ma_tinh_thanh_pho: tinhThanhPho.value,
//                                             ma_quan_huyen: quanHuyen.value,
//                                             ma_phuong_xa: phuongXa.value,
//                                             dia_chi_chi_tiet: diaChiChiTiet.value
//                                         },
//                                         success: function (response) {
//                                             if(response.success){
//                                                 let divCha = el.closest('div.address-option');
...
//                                                 var diaChiCT = "";
//                                                 if(response.dia_chi.dia_chi_chi_tiet){
//                                                     diaChiCT = response.dia_chi.dia_chi_chi_tiet + ", ";
//                                                 }
//                                                 divCha.querySelector('.address-home .dia-chi').textContent=diaChiCT +
//                                                 response.dia_chi.phuong_xa.ten_phuong_xa + ", " +
//                                                 response.dia_chi.quan_huyen.ten_quan_huyen+", " +
//                                                 response.dia_chi.tinh_thanh_pho.ten_tinh_thanh_pho+".";

//                                                 $('#edit-box').on('hide.bs.modal', function () {
//                                                     tinhThanhPho.innerHTML = "";  // Xóa các option cũ
//                                                     quanHuyen.innerHTML = "";
//                                                     phuongXa.innerHTML = "";
//                                                 });
//                                             }
